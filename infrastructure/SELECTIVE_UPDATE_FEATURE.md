...
## Summary
A new **Selective Stack Update Pipeline** has been added to enable independent updates of specific infrastructure stacks (Core, Base, or App) without deploying the entire stack hierarchy.
...
### Scenario 1: Update App Policies Only
**Situation**: You've updated app-specific IAM policies and don't want to redeploy Base or Core.
...
**Situation**: Security update affecting Core and App policies, needs documentation.
...
- CHANGE_DESCRIPTION: "Q1 2026 Security Hardening - Added MFA requirement"
```
